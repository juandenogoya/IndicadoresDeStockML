...
- docs/telegram_foto.md : "foto al cierre" por Telegram (25/9/2026) de los
                            tickers que marcaron las estrategias FT (2+ familias
                            + top por familia): RSI/MACD/volumen vs mediana 52s/
                            SMA50-200/earnings y las 5 ruedas previas. ESTADO, no
                            pronostico. Todavia fuera de la rutina diaria.
...
| `scripts/manual/telegram_foto.py` (+ `src/utils/foto_ticker.py`) | "Foto al cierre" por Telegram (25/9/2026): candidatos de la ultima corrida FT en 2+ FAMILIAS (no instancias: las 5 de TECH_SECTOR son una) + top 3 por familia por score, con RSI/MACD (umbrales de clasificacion_tecnica), volumen / mediana de 252 ruedas previas, SMA50/200, ruedas hasta earnings y tabla de 5 ruedas con cruces. Estado, no pronostico. `--dry-run` / `--tickers` / `--top`. LOCAL-only. Aun NO esta en rutina_diaria. Ver docs/telegram_foto.md |
