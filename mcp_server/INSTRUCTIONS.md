...
| Tendencia semanal (RSI/MACD) | calculado AL VUELO desde precios_diarios (src.utils.weekly_tf) | get_ticker_sintesis resamplea W-FRI y computa RSI14/MACD semanal en el momento. Ya NO lee indicadores_tecnicos_1w (tabla congelada, pipeline 1w deprecado 28/5/2026). Sin staleness guard: el semanal siempre esta fresco. |
