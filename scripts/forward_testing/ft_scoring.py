...
# La implementacion se MOVIO a src/strategies/scoring.py (Plan B, Tarea 16):
# cerebro de decision COMPARTIDO FT <-> Alpaca. Aca se RE-EXPORTA para que
# los importadores existentes (ft_bot_*, bt_*) sigan funcionando sin tocarse.
# ═══════════════════════════════════════════════════════════════
from src.strategies.scoring import (  # noqa: F401  (re-export retrocompatible)
    calcular_score_tecnico,
    PTS_SMA50, PTS_SMA21, PTS_MACD, PTS_RSI,
    SCORE_MAXIMO_TECH, RSI_MIN, RSI_MAX,
)
